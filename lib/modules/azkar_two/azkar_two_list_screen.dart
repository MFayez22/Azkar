...
class AzkarTwoListScreen extends StatefulWidget {
  ...
  AzkarTwoListScreen({Key? key, this.list, this.titleName}) : super(key: key);

  @override
  State<AzkarTwoListScreen> createState() => _AzkarTwoListScreenState();
}

class _AzkarTwoListScreenState extends State<AzkarTwoListScreen> {
  @override
